...
public class BRMO {
    public static void main(String[] args) throws InvalidCommandException {
        ...
        try {
            ...
            System.out.println("An error occurred while parsing dates in data file: " + e.getMessage());
        }
        ...
        try {
            ...
            System.out.println("An error occurred while parsing dates: " + e.getMessage());
        }
